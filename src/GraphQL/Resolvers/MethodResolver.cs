...
namespace GraphQL.Resolvers
{
    ...
    /// It has <see cref="CreateQueryArguments"/> method for correct arguments registration
    /// </summary>
    internal class MethodResolver : IFieldResolver
    {
        ...
        private static Func<object, object[], object> CreateOrGetResolveFunc(MethodInfo methodInfo)
            => cache.GetOrAdd(methodInfo, m =>
            {
                ...
                /* 
                 * body is like:
                 * object resolveFunc(object source, object[] params) => source.method((int)params[0], (srting)params[1], ... );
                */
